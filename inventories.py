...
int_arr_by_type_to_plot = pd.read_csv(\
    ...
    st.session_state.iso_country.replace(' ','%20')), usecols=int_arr_by_type_to_plot_cols)
...
int_dep_by_type_to_plot = pd.read_csv("https://raw.githubusercontent.com/james-stewart-808/inventory-tracker/main/datasets/inventories/{0}/int_dep_inv_by_vess_type.csv".format(st.session_state.iso_country.replace(' ','%20')), usecols=int_dep_by_type_to_plot_cols)
...
int_arr_by_port_to_plot = pd.read_csv("https://raw.githubusercontent.com/james-stewart-808/inventory-tracker/main/datasets/inventories/{0}/int_arr_inv_by_port.csv".format(st.session_state.iso_country.replace(' ','%20')), usecols=int_arr_by_port_to_plot_cols)
...
int_dep_by_port_to_plot = pd.read_csv("https://raw.githubusercontent.com/james-stewart-808/inventory-tracker/main/datasets/inventories/{0}/int_dep_inv_by_port.csv".format(st.session_state.iso_country.replace(' ','%20')), usecols=int_dep_by_port_to_plot_cols)
