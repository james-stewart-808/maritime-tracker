...
indicator = st.segmented_control(
    ...
    ["Number of Calls", "Energy Demand (TJ)", "GHG Emissions (t CO2e)", "NZF Costs in 2050 (US$)"]
)
if indicator == None:
...
int_arr_by_type_to_plot_cols = ["Int. Arr. by Type", "n_vys", "ene_tj", "co2e_t", "s24_50"]
...
int_dep_by_type_to_plot_cols = ["Int. Dep. by Type", "n_vys", "ene_tj", "co2e_t", "s24_50"]
...
# Read-in International Arrivals Inventory by Vessel Type Associated with the Country
int_arr_by_partner_to_plot_cols = ["Int. Arr. by Partner", "n_vys", "ene_tj", "co2e_t", "s24_50"]
...
# Read-in International Departures Inventory by Vessel Type Associated with the Country
int_dep_by_partner_to_plot_cols = ["Int. Dep. by Partner", "n_vys", "ene_tj", "co2e_t", "s24_50"]
...
# Read-in International Arrivals Inventory by Vessel Type Associated with the Country
int_arr_by_port_to_plot_cols = ["Int. Arr. by Port", "n_vys", "ene_tj", "co2e_t", "s24_50"]
...
# Read-in International Departures Inventory by Vessel Type Associated with the Country
int_dep_by_port_to_plot_cols = ["Int. Dep. by Port", "n_vys", "ene_tj", "co2e_t", "s24_50"]
